...
var fixedAgeValue_chartOptionsTooltip = {
    ...
    callbacks: {
        label: function (tooltipItem) {
            ...
            if (tooltipItem.datasetIndex < 7) { // if above 7 this dataset is polynomial data, so shouldn't be displayed
                ...
                var actualLabel = tooltipItem.dataset.label || '';
                if (actualLabel) {
                    actualLabel += ': ';
                }
                actualLabel += tooltipItem.parsed.y;

                // Setup the label and data for the polynomial value
                var polyLabel = 'Trend: ';
                polyLabel += tooltipItem.chart.config.data.datasets[tooltipItem.datasetIndex + 7].data[tooltipItem.dataIndex].y;
        ...
        labelColor: function (tooltipItem) {
            ...
            return {
                ...
                backgroundColor: tooltipItem.chart.config.data.datasets[useDatasetIndex].backgroundColor, // use the background color of the polynomial lines rather than the lower opacity actual data lines
...
var fixedAgeValue_chartOptionsPlugins = {
    ...
    //     return text.join('');
    // },
    tooltip: fixedAgeValue_chartOptionsTooltip,
}
...
var fixedAgeValue_chartOptionsYears = {
    ...
    tooltips: fixedAgeValue_chartOptionsTooltip,
    hover: fixedAgeValue_chartOptionsHover,
