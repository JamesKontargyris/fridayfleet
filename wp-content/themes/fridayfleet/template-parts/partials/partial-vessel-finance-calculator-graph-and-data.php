...
<section class="box">
    ...
    <div class="box__content">
        ...
        <div class="graph-update-button-group">
            <button onclick="resetZoom(['graph__depreciation'], 'btn--reset-zoom--vessel-finance-calculator')" class="btn btn--graph-update btn--reset-zoom--vessel-finance-calculator">
                Reset Zoom
            </button>
